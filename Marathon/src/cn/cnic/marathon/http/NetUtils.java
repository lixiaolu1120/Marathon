...
public class NetUtils {
	...
	/**
	 * 方法描述： 判断手机是否连接网络 </br> 修改备注： 返回类型： true 或 false </br>
	 * */
	 ...
	 * ON_LINE_WLAN WLAN连接</br> 修改备注：</br> 返回类型：0——未联网，1——GPRS网络，2——WLAN。
	 * */
	public static int getWlanState(Context context) {
		...
		boolean gprs = mConnectivityManager.getNetworkInfo(
	...
	/**
	 * 方法描述： 打开系统GPS设置界面 </br> 返回类型：true或false</br>
	 * 
	 * @param Context
	 *            </br>
	 * */
